...
//	W5500_SCS    --->		STM32_GPIOA4
///*W5500的片选管脚*/ 	W5500_SCLK	 --->	  STM32_GPIOA5
///*W5500的时钟管脚*/
//  W5500_MISO	 --->		STM32_GPIOA6
//  /*W5500的MISO管脚*/
//	W5500_MOSI	 --->		STM32_GPIOA7
///*W5500的MOSI管脚*/ 	W5500_RESET	 --->   STM32_GPIOC0
///*W5500的RESET管脚*/ 	W5500_INT		 --->		STM32_GPIOC1
///*W5500的INT管脚*/

/*W5500接STM32的 SPI2硬件接线定义*/
//	W5500_SCS 	--->	 STM32_GPIOB12
///*W5500的片选管脚*/ 	W5500_SCLK	--->	 STM32_GPIOB13
///*W5500的时钟管脚*/
//  W5500_MISO	--->	 STM32_GPIOB14
//  /*W5500的MISO管脚*/
//	W5500_MOSI	--->	 STM32_GPIOB15
///*W5500的MOSI管脚*/ 	W5500_RESET	--->   STM32_GPIOB9
///*W5500的RESET管脚*/ 	W5500_INT		--->   STM32_GPIOC6
///*W5500的INT管脚*/
...
uint16 wiz_write_buf(uint32 addrbsb, uint8 *buf,
					 uint16 len); /*向W5500写入len字节数据*/
uint16 wiz_read_buf(uint32 addrbsb, uint8 *buf,
					uint16 len); /*从W5500读出len字节数据*/
